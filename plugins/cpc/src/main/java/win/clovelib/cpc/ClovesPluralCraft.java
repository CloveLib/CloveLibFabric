...
import win.clovelib.cpc.commands.SystemCommand;
import win.clovelib.cpc.commands.FrontCommand;
import win.clovelib.cpc.commands.ChatProxyListener;
import win.clovelib.cpc.listeners.SkinChanger;
...
public class ClovesPluralCraft implements ModInitializer {
	public static final String MOD_ID = "cpc";
